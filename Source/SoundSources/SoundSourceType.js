...
class SoundSourceType_Instances {
    constructor() {
        ...
        this.Sawtooth = new SoundSourceType("Sawtooth", () => { return new SoundSource_Sawtooth(); }, (objectToSet) => {
        ...
        this.Sine = new SoundSourceType("Sine", () => { return new SoundSource_Sine(); }, (objectToSet) => {
            Object.setPrototypeOf(objectToSet, SoundSource_Sine.prototype);
        });
        this.Square = new SoundSourceType("Square", () => { return new SoundSource_Square(); }, (objectToSet) => {
            Object.setPrototypeOf(objectToSet, SoundSource_Square.prototype);
        });
        this.Triangle = new SoundSourceType("Triangle", () => { return new SoundSource_Triangle(); }, (objectToSet) => {
            Object.setPrototypeOf(objectToSet, SoundSource_Triangle.prototype);
        });
        this.Vibrato = new SoundSourceType("Vibrato", () => {
            return new SoundSource_Vibrato(16, // pitchChangesPerSecond
            // pitchMultipliers
            [
                1,
                1.004
        ...
        this.WavFile = new SoundSourceType("WavFile", () => { return new SoundSource_WavFile("C_3", null); }, (objectToSet) => {
        ...
        this._AllByName =
            ArrayHelper.addLookups(this._All, (t) => t.name);
    }
    byName(name) {
