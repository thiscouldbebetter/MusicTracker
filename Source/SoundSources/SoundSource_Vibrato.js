...
(function (ThisCouldBeBetter) {
    ...
    (function (MusicTracker) {
        class SoundSource_Vibrato extends MusicTracker.SoundSourceChild {
            constructor(pitchChangesPerSecond, pitchMultipliers, areTransitionsSmooth, child) {
                super(MusicTracker.SoundSourceType.Instances().Vibrato.name);
        ...
        MusicTracker.SoundSource_Vibrato = SoundSource_Vibrato;
