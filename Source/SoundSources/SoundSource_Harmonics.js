...
(function (ThisCouldBeBetter) {
    ...
    (function (MusicTracker) {
        class SoundSource_Harmonics extends MusicTracker.SoundSourceChild {
            constructor(relativeAmplitudesOfHarmonics) {
                super(MusicTracker.SoundSourceType.Instances().Harmonics.name);
                ...
                this._sine = new MusicTracker.SoundSource_Sine();
            }
            static default() {
        ...
        MusicTracker.SoundSource_Harmonics = SoundSource_Harmonics;
