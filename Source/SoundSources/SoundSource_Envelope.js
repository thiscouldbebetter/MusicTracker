...
(function (ThisCouldBeBetter) {
    ...
    (function (MusicTracker) {
        class SoundSource_Envelope extends MusicTracker.SoundSourceChild {
            constructor(ticksPerSecond, attackDurationInTicks, decayDurationInTicks, sustainDurationInTicks, sustainAmplitudeMultiplier, releaseDurationInTicks, child) {
                super(MusicTracker.SoundSourceType.Instances().Envelope.name);
            ...
            static default() {
                return new SoundSource_Envelope(1000, // ticksPerSecond
        ...
        MusicTracker.SoundSource_Envelope = SoundSource_Envelope;
