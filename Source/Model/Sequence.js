    ...
    (function (MusicTracker) {
        class Sequence {
            ...
            static blank(instrumentName, numberOfSequencesSoFar) {
                ...
                sequenceDurationInSeconds * ticksPerSecond, // durationInTicks
                [
                    new MusicTracker.Track(instrumentName, [] // notes
                    )
                ]);
                return returnValue;
            }
            ...
            tickSelectedAsString() {
                ...
                var tickAsString = (noteAtTick == null ? MusicTracker.Note.Blank : noteAtTick.toString());
                return tickAsString;
            }
            ...
            // cloneable
            clone() {
                return new Sequence(this.name + "_Cloned", this.ticksPerSecond, this.durationInTicks, MusicTracker.ArrayHelper.clone(this.tracks));
            }
            // samples
            toSamples(song) {
            ...
            uiUpdate_Create(song) {
                ...
                timeSubdivisionFactors.forEach(x => {
                ...
                buttonSequenceSelectedTimeSubdivide.onclick = () => {
                    ...
                    var timeSubdivisionFactor = MusicTracker.RationalNumber.fromString(timeSubdivisionFactorAsString);
                    var isTimeSubdivisionPossible = sequence.timeSubdivideByFactorIsPossible(timeSubdivisionFactor);
            ...
            uiUpdate_Tracks_Create(song) {
                ...
                buttonTrackNew.onclick = () => {
                    ...
                    var track = new MusicTracker.Track(instrument.name, []);
                ...
                buttonTrackSelectedDelete.onclick = () => {
                    ...
                    if (tracks.length > 1) {
                        var trackSelected = sequence.trackSelected();
                        MusicTracker.ArrayHelper.remove(tracks, trackSelected);
                ...
                inputTickSelected.onkeypress = (event) => {
                    ...
                    if (keyPressed == "Enter") {
                        ...
                        var tickAsNote = MusicTracker.Note.fromString(tickAsString, tickIndex);
            ...
            uiUpdate_TickCursorPositionFromSelected(shouldHighlightWholeTick) {
                ...
                var charsPerTrack = trackDelimiter.length + MusicTracker.Note.Blank.length;
                var newline = "\n";
                ...
                if (shouldHighlightWholeTick) {
                    ...
                    selectionSize = MusicTracker.Note.Blank.length;
                }
                var selectTicks = this.selectTicks;
        ...
        MusicTracker.Sequence = Sequence;
